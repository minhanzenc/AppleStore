...
sNext:"Trang sau",sPrevious:"Trang trước"},sEmptyTable:"Không có dữ liệu trong bảng.",sInfo:"Hiển thị _START_ đến _END_ của _TOTAL_ mục.",sInfoEmpty:"Hiển thị 0 đến 0 của 0 mục.",sInfoFiltered:"(Được lọc từ tổng số _MAX_  mục)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ mục.",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm nhanh:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
